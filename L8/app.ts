...
const res = merge({ name: "ajeet" }, { role: "Software engineer" }, { id: "d1" });
// console.log(res);
...
// const stringBox2 : Box<object> = {value : {name:"Ajeet"}}
...
const person = {name:"Ajeet", age:21};
// const person2 = {fullname:"Ajeet", salary:21};
