...
// const combinedName = combine("Ajeet", " Mern"); // Ajeet Mern
...
// const combinedName = combine("Ajeet", " Mern", "as-string"); // Ajeet Mern
...
function combine1(num1: Combinable, num2: Combinable, conversionType: ConversionType) {
    let result;
    if (typeof num1 === "number" && typeof num2 === "number" || conversionType === "as-number") {
        result = +num1 + +num2;
    } else {
...
const sum3= combine("10", "20", "as-number"); // 30
const sum4 = combine(10, 50, "as-number");
const combinedName1 = combine("Ajeet", " Mern", "as-string"); // Ajeet Mern
console.log(sum1, sum2, combinedName);
